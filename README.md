...
<li>pcontrol_ttk.py: A basic control panel, like pcontrol.py. (Using tkk module from Tkinter)</li>
...
<li>pcontrol_ttk.py: Un panel de control básico, igual a pcontrol.py. (Se usa el módulo de tkk de Tkinter)</li>
