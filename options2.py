...
# Modules
from PyQt5.QtWidgets import (QAction, qApp, QApplication, QComboBox, QGridLayout,
...
class Options(QWidget):
    ...
    def __init__(self):
        ...
        # Create buttons
        self.firstButton = QPushButton('Crispy Chicken Wings', self)
        self.secondButton = QPushButton('Gazpacho', self)
        self.thirdButton = QPushButton('', self)        # Third button is empty initially
